                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input v-model="form.name" type="text" class="form-control" name="name" placeholder="Name" :class="{ 'is-invalid': form.errors.has('name') }">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input v-model="form.phone" type="text" class="form-control" name="phone" placeholder="Phone" :class="{ 'is-invalid' : form.errors.has('phone') }">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" class="form-input" @change="updateProfile" name="photo" :class="{ 'is-invalid' : form.errors.has('photo') }">
