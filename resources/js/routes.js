export const routes = [
    ...
    { path: '/login', components: require('./components/auth/Login.vue'), meta:{ requireVisitor : true } },
    { path: '/register', components: require('./components/auth/Register.vue'), meta:{ requireVisitor : true } },
